...
from dstoolkit.helpers import is_json_serializable
...
class Log(metaclass=Singleton):
    ...
    def __init__(self, name: str = None, connection_string: str = None):
        """
...
def trace(original_function: Any = None, *, attrs_refact: List[str] = None):
    ...
    def __log(func, fn_k, *args, **kwargs):
        ...
        Log.get_instance().log_info(
            message=f"Executed function {func.__module__}.{func.__qualname__}",
            custom_dimension=fn_k
        )
        return res
